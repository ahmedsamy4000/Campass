        ...
        <Box sx={{ width: '100%', position: "absolute" }}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }} display={'flex'} justifyContent={'end'}>
                <Tabs value={value} onChange={handleChange} aria-label="basic tabs example"
                    ...
                    <Tab label="Home" component={Link} to="/" sx={{ color: "white", '&.Mui-selected': { color: '#DFD0B8' }, marginRight: "230px" }} />
                    <Tab label="Contact Us" component={Link} to="/contact" sx={{ color: "white", '&.Mui-selected': { color: '#DFD0B8' }, marginRight: "230px" }} />
                    ...
                    <Tab label={<AccountCircleOutlinedIcon></AccountCircleOutlinedIcon>} component={Link} to="/signin" sx={{ color: "white", '&.Mui-selected': { color: '#DFD0B8' } }} />
                </Tabs>
